<div class="w-full h-12 bg-gray-100 border-gray-200 dark:bg-gray-700 dark:border-gray-600">
    <button onclick="changeDarkMode()"
        ...
        <div class="absolute right-2 top-2 invisible dark:visible">
            <svg aria-hidden="true" data-toggle-icon="sun" class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"
        ...
        <div class="absolute right-2 top-2 dark:invisible">
            <svg aria-hidden="true" data-toggle-icon="moon" class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"
                 xmlns="http://www.w3.org/2000/svg">
